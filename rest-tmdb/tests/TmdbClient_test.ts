...
Deno.test('[rest-tmdb] should get movie genres', async () => {
  const results = await client.genre.movies()
  assertNotEquals(results.genres.length, 0)
})

Deno.test('[rest-tmdb] should get tv genres', async () => {
